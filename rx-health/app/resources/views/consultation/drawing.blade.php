<div class="content">
    ...
    <script type="text/javascript" src="{{ asset('packages/wPaint/lib/jquery.ui.widget.1.10.3.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('packages/wPaint/lib/jquery.ui.mouse.1.10.3.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('packages/wPaint/lib/jquery.ui.draggable.1.10.3.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('packages/wPaint/plugins/main/wPaint.menu.main.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('packages/wPaint/plugins/text/wPaint.menu.text.min.js') }}"></script>
    <script
