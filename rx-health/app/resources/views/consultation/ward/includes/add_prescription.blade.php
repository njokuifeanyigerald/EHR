    ...
    <div class="card-body">
        <form action="">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2 col-sm-3 col-lg-4 col-3 mt-2">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="stat" name="cb_name" class="custom-control-input" value="stat" />
                ...
                <div class="col-md-2 col-sm-3 col-lg-4 col-3 mt-2">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="nocte" name="cb_name" class="custom-control-input" value="nocte" />
