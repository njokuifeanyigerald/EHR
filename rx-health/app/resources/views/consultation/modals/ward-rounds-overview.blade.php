{{-- Ward rounds overview --}}
<div id="ward_rounds_overview" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div id="doctors-items" class="list-group">
                                    <a href="#medicalTab" class="list-group-item list-group-item-action active">
                                        Medical Notes
                                    </a>
                                    <a href="#diagnosisTab" class="list-group-item list-group-item-action">Diagnosis</a>
                                    <a href="#labTab" class="list-group-item list-group-item-action">Lab</a>
                                    <a href="#procedureTab" class="list-group-item list-group-item-action">Procedure</a>
                                    ...
                                    <a href="#drawingsTab" class="list-group-item list-group-item-action">Drawings</a>
                                </div>
                            </div>
                                                    ...
                                                    <div class="row d-flex justify-content-between">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <br />
                                                                <li style="list-style: none">
                                                                    <span style="color: #000000">Abidec Drops:</span>
                                                                    days
                                                                    <span
                                                                        class="iq-bg-success ps-3 pe-3 pt-2 pb-2 rounded-5 d-inline-block fst-italic fw-bold"
                                                                    >
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div id="nurses-items" class="list-group">
                                    ...
                                    <a href="#treatmentTab" class="list-group-item list-group-item-action">Treatment</a>
                                    <a href="#fluidTab" class="list-group-item list-group-item-action">Fluid Balance</a>
                                    <a href="#urineTab" class="list-group-item list-group-item-action">Urine Chart</a>
                                    <a href="#bloodGluTab" class="list-group-item list-group-item-action">Glycaemia</a>
                                    ...
                                    <a href="#foetalTab" class="list-group-item list-group-item-action">Foetal Kick</a>
                                    <a href="#anaestheticTab" class="list-group-item list-group-item-action">
                                        Anaesthetic
                                    </a>
                                    <a href="#operationTab" class="list-group-item list-group-item-action">Operation</a>
                            ...
                            <div class="col-lg-10 rounded rx-bg-silver py-3" style="height: 70vh; overflow-y: scroll">
                                ...
                                >
                                    ...
                                    <div class="card card-custom card-collapsed mt-4 rx-bg-silver" data-card="true">
                                        ...
                                        <div id="treatCollapse" class="collapse show bg-white rounded bg-white rounded">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table
                                                        class="table table-head-custom cursor table-hover table-responsive-lg"
