        ...
        @if ($reportData && in_array($reportType, ['lab_requisition_report', 'lab_revenue_report', 'top_labs']))
                        ...
                        <div class="iq-card-body">
                            <div class="table-responsive">
                                <table
                                    ...
                                    data-export-options='{"fileName": "Lab-Requisition-Report-date"}'
                                >
                                    <thead>
                                        <tr>
                        ...
                        <div class="iq-card-body">
                            <div class="table-responsive">
                                <table
                                    ...
                                    data-export-types="[ 'csv', 'pdf','excel']"
                                    data-export-footer="true"
                                    data-export-options='{"fileName": "Lab-Revenue-Report-date"}'
                                >
                                    <thead>
                                        <tr>
            ...
            @if ($reportType == 'top_labs')
                @if (isset($reportData[0]['graph_option']) && $reportData[0]['graph_option'] == 'bar')
                    {{-- top Labs by quantity sold Report --}}
                    <div class="col-md-12 col-lg-12">
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">Top Labs (By Quantity Sold)</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                                {{-- bar chart --}}
                                ...
                                {{-- bar chart --}}
                                <div class="card-body">
                                    <div id="bar_lab_value" style="width: 100%; height: 400px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if (isset($reportData[0]['graph_option']) && $reportData[0]['graph_option'] == 'pie')
                    {{-- top Labs by value Report --}}
                    <div class="col-md-12 col-lg-12">
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">Top Labs (By value)</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                                {{-- pie chart --}}
                                ...
                                {{-- pie chart --}}
                                <div class="card-body">
                                    <div id="pie_lab_value" style="width: 100%; height: 400px"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (jsonData != null && jsonData.length > 0) {
                ...
                if (jsonData[0]['graph_option'] == 'pie') {
                    ...
                    display_pie_chart('pie_lab_value', 'Top labs by value', 'Value', Object.entries(labValueData));
                }
            }
        });
    </script>
