                ...
                <div id="pdf_div" class="col-sm-11 printable">
                    <div class="iq-card px-3">
                        <div class="iq-card-body">
                                ...
                                <div class="col-sm-12 my-3 border rounded-3 p-3 bg-light">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <br />
                                            <span class="text-dark">
                                                {{-- {{ $visit->paymentMode->name ?? 'No payment method' }} --}}
                                                {{ 'Cash' }}
                                            </span>
                                        </div>
                                        <div class="col-sm-4">
                                ...
                                <div class="col-sm-12 border rounded-3 px-0">
                                    <div class="table-responsive">
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                @forelse ($visit_details as $visitDetail)
                                                    <tr>
                                                        <td>
                                                            {{ $visitDetail->item?->item_name ?? 'No Item Specified' }}
                                                        </td>
                                                        <td>{{ $visitDetail->frequency }}</td>
                                                        <td>{{ $visitDetail->days }}</td>
                                                        <td>{{ $visitDetail->dose }}</td>
                                                        <td>{{ $visitDetail->dosage_unit }}</td>
                                                        <td>{{ $visitDetail->route }}</td>
                                                    </tr>
                                                @empty
                                                    <tr>
                            ...
                            {{-- $amountPaid = $visit->paymentRecords->sum('payment_amount'); --}}
                            {{-- @endphp --}}
