{{-- create role modal --}}
<div id="add_role" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-10 col-sm-12">
                        <textarea class="form-control my-2" id="exampleFormControlTextarea1" rows="2"></textarea>
                    </div>
                </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="customChec7" />
