<!-- Add labs Modal -->
<div class="modal fade" id="add_labs" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="table-responsive overflow-auto" style="max-height: 260px">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-wrap">24 HOUR URINE PROTEIN</td>
                                                <td>180.00</td>
                                                <td><i class="fa fa-plus text-primary" style="cursor: pointer"></i></td>
                                            </tr>
                                            <tr>
                                                <td class="text-wrap">UREA & CREATININE FOR CT</td>
                                                <td>650.00</td>
                                                <td><i class="fa fa-plus text-primary" style="cursor: pointer"></i></td>
                                            </tr>
                                            <tr>
                                                <td class="text-wrap">24HR URINE ELECTROLYTES</td>
                                                <td>300.00</td>
                                                <td><i class="fa fa-plus text-primary" style="cursor: pointer"></i></td>
                                            </tr>
                                            <tr>
                                                <td class="text-wrap">(APTT)ACTIVATED PARTIAL THROMBOPLASTIN TIME</td>
                                                <td>700.00</td>
                                                <td><i class="fa fa-plus text-primary" style="cursor: pointer"></i></td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="col-lg-8">
                        <div class="iq-card shadow">
                            ...
                            <div class="iq-card-body">
                                ...
                                <div>
                                    <button type="button" class="btn mb-3 me-2 btn-success rounded-pill">
