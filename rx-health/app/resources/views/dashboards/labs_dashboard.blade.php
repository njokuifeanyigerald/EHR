    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="iq-card iq-card-block iq-card-height">
                        <div class="iq-card-body p-2">
                            <div id="lab_requests" style="height: 200px"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="iq-card iq-card-block iq-card-height">
                        <div class="iq-card-body p-3">
                            <h6 class="fw-bold">Patients Status</h6>
                            ...
                            <div class="mt-4">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 text-dark">Pending Patients</div>
                                        <div class="col-md-2 text-dark">10%</div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-1"><i class="fa fa-circle text-success"></i></div>
                                        <div class="col-md-8 text-dark">Completed Patients</div>
                                        <div class="col-md-2 text-dark">90%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="iq-card iq-card-block iq-card-height">
                        <div class="iq-card-body px-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="rounded-circle iq-card-icon iq-bg-secondary">
                                    <i class="fa fa-microscope"></i>
                                </div>
                                <div>
                                    <h3 class="mb-0 fw-bold"><span class="counter">178</span></h3>
                                    <h6 class="">Lab Tests</h6>
                                </div>
                            </div>
        ...
        <div class="col-lg-4">
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title fw-bold text-muted">Outsourced Lab Tests</h4>
                    </div>
                </div>
                <div class="iq-card-body">
        ...
        <div class="col-lg-8">
            <div class="iq-card iq-card-block iq-card-height">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title fw-bold text-muted">Recent Tests</h4>
                    </div>
                </div>
                <div class="iq-card-body">
        ...
        <div class="col-md-6">
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title fw-bold text-muted">Top 10 Lab Tests</h4>
                    </div>
                    <div class="iq-card-header-toolbar d-flex align-items-center">
                ...
                <div class="iq-card-body text-center">
                    <div class="row mb-4">
                        <div class="col-md-2 mb-0">
                            <p class="mb-0 text-dark font-size-14">Urine Test</p>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-2 mb-0">
                            <p class="mb-0 text-dark font-size-14">Blood Test</p>
                        </div>
                        <div class="col-6 my-auto">
                            <div class="iq-progress-bar-linear d-inline-block w-100">
                                <div class="iq-progress-bar rx-progress-bar-h">
        ...
        <div class="col-md-6">
            <div class="iq-card iq-card-block iq-card-height">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title fw-bold text-muted">Lab Test Status</h4>
                    </div>
                </div>
                <div class="iq-card-body">
