<div>
                            ...
                            <div class="iq-card shadow">
                                <div class="iq-card-header d-flex justify-content-between bg-light">
                                    ...
                                    {{--
                                        ...
                                        <span class="me-2">Order Date: May 2024</span>
                                        </div>
                                    --}}
                                </div>
                                <div class="iq-card-body">
    ...
    {{-- Errors for the edits --}}
    @if ($errors->get('edit_details.*.unit_price') || $errors->get('edit_details.*.quantity') || $errors->get('edit_details.*.pack_size'))
        {{-- {{ dd(array_values($errors->get('edit_details.*.quantity'))[0][0]) }} --}}
        {{
            $this->alert(
                'error',
                array_values($errors->get('edit_details.*.unit_price'))[0][0] ??
                    (array_values($errors->get('edit_details.*.quantity'))[0][0] ??
                        array_values($errors->get('edit_details.*.pack_size'))[0][0]),
            )
        }}
    @endif
