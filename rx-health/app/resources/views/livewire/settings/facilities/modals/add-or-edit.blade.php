<div>
    <div wire:ignore.self id="facility_form" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="my-4">
                        <div class="tab-content" id="pills-tabContent-2">
                            ...
                            <div
                                ...
                                id="tax_setting"
                                role="tabpanel"
                                aria-labelledby="tax_setting-tab"
                            >
                                        ...
                                        <table class="table cursor table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Tax Exclusive</td>
                                                    <td>
                                                        <input class="form-control" type="text" value="0.8385744" />
                                                    </td>
                                                    <td>
                                                        <select class="form-select">
                                                ...
                                                <tr>
                                                    <td>Covid Levy</td>
                                                    <td>
                                                        <input class="form-control" type="text" value="0.0100000" />
                                                    </td>
                                                    <td>
                                                        <select class="form-select">
                                                            <option selected="" value="Active">Active</option>
                                                ...
                                                <tr>
                                                    <td>NHIL</td>
                                                    <td>
                                                        <input class="form-control" type="text" value="0.0250000" />
                                                    </td>
                                                    <td>
                                                        <select class="form-select">
                                                            <option selected="" value="Active">Active</option>
