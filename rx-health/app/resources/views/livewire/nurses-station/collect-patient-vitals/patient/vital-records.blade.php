                                                                            ...
                                                                            <thead>
                                                                                <tr>
                                                                                    <th scope="col" class="p-2">
                                                                                        <div
                                                                                            class="me-2 d-flex justify-content-center align-content-center gap-2"
                                                                                            title="Temperature"
                                                                                        >
                                                                                            <i
                                                                                                class="text-primary fa fa-thermometer-half icons-base"
                                                                                            ></i>
                                                                                    ...
                                                                                    <th scope="col" class="p-2">
                                                                                        ...
                                                                                        >
                                                                                            <i
                                                                                                class="text-primary fa fa-balance-scale icons-base"
                                                                                            ></i>
                                                                                            <span class="text-muted">
                                                                                                kg
                                                                                            </span>
                                                                                    ...
                                                                                    <th scope="col" class="p-2">
                                                                                        ...
                                                                                        >
                                                                                            <i
                                                                                                class="text-primary fa fa-arrows-v icons-base"
                                                                                            ></i>
                                                                                            <span class="text-muted">
                                                                                                cm
                                                                                            </span>
                                                                                    ...
                                                                                    <th scope="col" class="p-2">
                                                                                        ...
                                                                                        >
                                                                                            <i
                                                                                                class="text-primary fa fa-heartbeat icons-base"
                                                                                            ></i>
                                                                                            <span class="text-muted">
                                                                                                bpm
                                                                                            </span>
                                                                                    ...
                                                                                    <th scope="col" class="p-2">
                                                                                        ...
                                                                                        >
                                                                                            <i
                                                                                                class="text-primary fa fa-heart icons-base"
                                                                                            ></i>
                                                                                            <span class="text-muted">
                                                                                                mmHg
                                                                                            </span>
                                                                                                ...
                                                                                                >
                                                                                                    <g>
                                                                                                        <path
                                                                                                            style="
                                                                                                                fill: #78909c;
                                                                                                            "
                                                                                                            d="M262,86.4c0-0.8,0.4-3.2,0.4-3.2H248v23.6h14.8c-0.8-4-1.2-8.8-1.2-13.6 C261.6,92.8,261.6,90.8,262,86.4z"
                                                                                                        ></path>
                                                                                                        <rect
                                                                                                            x="192.4"
                                                                                                            y="122.4"
                                                                                                    ...
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #ffcdd2;
                                                                                                        "
                                                                                                        d="M136,296.4c0-0.4,0.4-0.8,0.4-1.2C136,295.2,136,296,136,296.4z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #e0f2f1;
                                                                                                        "
                                                                                                        d="M264.4,246l0.4-0.8h-87.2c-0.8,0-2,0.4-2-0.4c-23.2,15.6-38,42.4-38,68.4V494h162V312.8 C299.2,285.2,286.8,260,264.4,246z"
                                                                                                    ></path>
                                                                                                    <g>
                                                                                                        <path
                                                                                                            style="
                                                                                                                fill: #ffcdd2;
                                                                                                            "
                                                                                                            d="M134.4,307.6c0-0.8,0-1.6,0.4-2.4C134.4,306,134.4,306.8,134.4,307.6z"
                                                                                                        ></path>
                                                                                                        <path
                                                                                                            style="
                                                                                                                fill: #ffcdd2;
                                                                                                            "
                                                                                                            d="M134,502v2h2C134.8,504,134,503.2,134,502z"
                                                                                                        ></path>
                                                                                                    </g>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #e0e0e0;
                                                                                                        "
                                                                                                        d="M180,241.6c0,0,0.4-0.4,0,3.6h78c0-4-0.8-3.2-0.8-3.2c-0.8-0.4-1.6-0.4-1.6-1.2v-31.2h-75.2v31.2 C180.8,241.6,180.8,241.2,180,241.6z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #ffcdd2;
                                                                                                        "
                                                                                                        d="M134.8,302c0-0.8,0.4-1.6,0.4-2.4C135.2,300.4,134.8,301.2,134.8,302z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #eeeeee;
                                                                                                        "
                                                                                                        d="M163.6,94.8c0,13.2,10.8,23.6,23.6,23.6h56.4V70.8h-56.4C174.4,71.2,163.6,82,163.6,94.8z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #ffcdd2;
                                                                                                        "
                                                                                                        d="M187.6,124c-0.8,0-1.6,0-2.8,0C185.6,123.6,186.4,124,187.6,124z"
                                                                                                    ></path>
                                                                                                    <polyline
                                                                                                        style="
                                                                                                            fill: #e0e0e0;
                                                                                                        "
                                                                                                        points="338.8,4 338.8,186 366.4,186 366.4,4 "
                                                                                                    ></polyline>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #bcaaa4;
                                                                                                        "
                                                                                                        d="M338.8,11.6c-35.6,3.6-67.2,33.6-72.8,70l0.4,0.4c0,0.4,0,0.8,0,0.8c0,1.2-0.4,2.4-0.4,4 c-0.4,5.2-1.2,6.8-1.2,7.2c0,42.8,34.4,78.4,74,82.4V11.6"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #ffcdd2;
                                                                                                        "
                                                                                                        d="M340,189.2v2h2C340.8,191.2,340,190.4,340,189.2z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M190.4,209.6c-2.4,0-4-1.6-4-4v-83.2c0-2.4,1.6-4,4-4s4,1.6,4,4v83.2C194.4,207.6,192.8,209.6,190.4,209.6z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M246,209.6c-2.4,0-4-1.6-4-4v-86.8c0-2.4,1.6-4,4-4s4,1.6,4,4v86.8C250,207.6,248,209.6,246,209.6z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M301.2,496h-166c-2.4,0-4-1.6-4-4V312.8c0-28.8,16.8-58,43.6-74.4v-30.8c0-2.4,1.6-4,4-4H258c2.4,0,4,1.6,4,4v30.8 c27.2,14.8,43.6,42.4,43.6,74.8v179.2C305.2,494.4,303.6,496,301.2,496z M139.2,488h158V312.8c0-30-15.6-55.6-41.2-68.8 c-1.2-0.8-2-2-2-3.6v-29.2h-71.2v29.2c0,1.6-0.8,2.8-2,3.6c-25.2,14.8-41.6,42-41.6,68.8V488z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M224,247.2h-47.6c-2.4,0-4-1.6-4-4s1.6-4,4-4H224c2.4,0,4,1.6,4,4S226.4,247.2,224,247.2z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M259.6,247.2h-12c-2.4,0-4-1.6-4-4s1.6-4,4-4h12c2.4,0,4,1.6,4,4S262,247.2,259.6,247.2z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M246,124.8h-58.4c-16.4,0-29.6-13.2-29.6-29.6s13.2-29.6,29.6-29.6H246c2.4,0,4,1.6,4,4v51.2C250,122.8,248,124.8,246,124.8 z M187.6,73.2c-12,0-21.6,9.6-21.6,21.6s9.6,21.6,21.6,21.6H242V73.2H187.6z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M368.4,191.6h-27.6c-2.4,0-4-1.6-4-4V182c-44-4.8-78-42.8-78-88c0-0.8,0-1.6,0.4-4c0.4-1.2,0.4-2.8,0.4-3.6 c3.6-44.4,34.8-77.2,75.6-80c2,0,4,1.6,4.4,3.6c0,2.4-1.6,4-3.6,4.4c-36.8,2.4-64.4,32.4-68,72.8c0,0.8-0.4,2.4-0.4,4 c0,1.2-0.4,2.4-0.4,2.8c0,42.4,32.8,77.6,74.4,80.4c2,0,3.6,2,3.6,4v5.2h19.6V4c0-2.4,1.6-4,4-4s4,1.6,4,4v183.6 C372.4,190,370.8,191.6,368.4,191.6z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M340.8,190c-2.4,0-4-1.6-4-4V55.6c0-2.4,1.6-4,4-4s4,1.6,4,4V186C344.8,188,342.8,190,340.8,190z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M340.8,27.6c-2.4,0-4-1.6-4-4V4c0-2.4,1.6-4,4-4s4,1.6,4,4v19.6C344.8,26,342.8,27.6,340.8,27.6z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M263.6,112.8h-16c-2.4,0-4-1.6-4-4s1.6-4,4-4h16c2.4,0,4,1.6,4,4S266,112.8,263.6,112.8z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M259.6,85.2h-12c-2.4,0-4-1.6-4-4s1.6-4,4-4h12c2.4,0,4,1.6,4,4S262,85.2,259.6,85.2z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        d="M366.4,8h-25.6c-2.4,0-4-1.6-4-4s1.6-4,4-4h25.6c2.4,0,4,1.6,4,4S368.8,8,366.4,8z"
                                                                                                    ></path>
                                                                                                </g>
                                                                                            </svg>
                                                                                            <span class="text-muted">
                                                                                                    ...
                                                                                                    <g>
                                                                                                        ...
                                                                                                        <path
                                                                                                            style="
                                                                                                                fill: #629c9d;
                                                                                                            "
                                                                                                            d="M205.655,59.941C172.917,97.978,140.613,142.459,143.5,192.5 c1.571,20.425,6.152,50.034-4.571,69.536l33.102,33.102c69.95-11.138,123.611-71.117,124.934-143.887L205.655,59.941z"
                                                                                                        ></path>
                                                                                                        <g>
                                                                                                            <g>
                                                                                                                <path
                                                                                                                    style="
                                                                                                                        fill: #345065;
                                                                                                                    "
                                                                                                                    d="M148.5,223.75L148.5,223.75c37.003,0,67-29.997,67-67V82.547 c0-17.167-13.916-31.083-31.083-31.083h-71.834C95.416,51.464,81.5,65.38,81.5,82.547v74.203 C81.5,193.753,111.497,223.75,148.5,223.75z"
                                                                                                                ></path>
                                                                                                            </g>
                                                                                                            <g>
                                                                                                                <rect
                                                                                                            ...
                                                                                                            <g>
                                                                                                                <path
                                                                                                                    style="
                                                                                                                        fill: #ecf0f1;
                                                                                                                    "
                                                                                                                    d="M117.127,147.179h62.746c3.818,0,6.913-3.095,6.913-6.913V77.52c0-3.818-3.095-6.913-6.913-6.913 h-62.746c-3.818,0-6.913,3.095-6.913,6.913v62.746C110.214,144.084,113.309,147.179,117.127,147.179z"
                                                                                                                ></path>
                                                                                                            </g>
                                                                                                            <g>
                                                                                                                <g>
                                                                                                                    <path
                                                                                                                        style="
                                                                                                                            fill: #aec1cf;
                                                                                                                        "
                                                                                                                        d="M146.76,157.62h-27.747c-4.859,0-8.798,3.939-8.798,8.798c0,11.8,9.566,21.366,21.366,21.366 h15.179V157.62z"
                                                                                                                    ></path>
                                                                                                                </g>
                                                                                                                <g>
                                                                                                                    <path
                                                                                                                        style="
                                                                                                                            fill: #aec1cf;
                                                                                                                        "
                                                                                                                        d="M177.988,157.62H150.24v30.165h15.179c11.8,0,21.366-9.566,21.366-21.366 C186.786,161.559,182.847,157.62,177.988,157.62z"
                                                                                                                    ></path>
                                                                                                                </g>
                                                                                                            </g>
                                                                                                        </g>
                                                                                                        <g>
                                                                                                            <path
                                                                                                                style="
                                                                                                                    fill: #d35400;
                                                                                                                "
                                                                                                                d="M132,115.5c0-9.113,16.5-33,16.5-33s16.5,23.887,16.5,33s-7.387,16.5-16.5,16.5 S132,124.613,132,115.5z"
                                                                                                            ></path>
                                                                                                        </g>
                                                                                                    </g>
                                                                                                </g>
                                                                                    ...
                                                                                    <th scope="col" class="p-2">
                                                                                        ...
                                                                                        >
                                                                                            <i
                                                                                                class="text-primary fa fa-area-chart icons-base"
                                                                                            ></i>
                                                                                            <span class="text-muted">
                                                                                                BMI
                                                                                            </span>
                                                                                    ...
                                                                                    <th scope="col" class="p-2">
                                                                                        ...
                                                                                        >
                                                                                            <i
                                                                                                class="text-primary fa fa-stethoscope icons-base"
                                                                                            ></i>
                                                                                            <span class="text-muted">
                                                                                                Hypertension
                                                                                            </span>
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            >
                                                                                                ...
                                                                                                >
                                                                                                    ...
                                                                                                    <path
                                                                                                        class="c"
                                                                                                        d="M30.423,175.188c9.22-2.152,18.756-2.82,27.712-6.05,2.4-.867,1.367-4.734-1.063-3.857-8.957,3.23-18.492,3.9-27.712,6.05-2.506.585-1.445,4.443,1.063,3.857Z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        class="c"
                                                                                                        d="M98.218,133.154c-5.9-.014-11.794.013-17.69,0-2.575-.006-2.578,3.994,0,4,5.9.013,11.793-.014,17.69,0,2.574,0,2.578-4,0-4Z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        class="e"
                                                                                                        d="M28.754,166.337q1.588,3.155,2.862,6.453"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        class="a"
                                                                                                    ...
                                                                                                    <path
                                                                                                        class="c"
                                                                                                        d="M273.314,174.354q2.2.061,4.409.189,1.056.061,2.113.139.528.039,1.056.081l.616.051.264.023a1.173,1.173,0,0,1-.872-.4,2.163,2.163,0,0,0,1.414.585,2,2,0,0,0,1.414-3.414,3.175,3.175,0,0,0-1.838-.758c-.39-.042-.783-.069-1.174-.1q-1.232-.1-2.465-.174-2.466-.153-4.937-.221a2.016,2.016,0,0,0-2,2,2.04,2.04,0,0,0,2,2Z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        class="c"
                                                                                                        d="M171.618,170.354q-2.47.069-4.937.221-1.233.077-2.465.174c-.391.031-.784.055-1.174.1a3.232,3.232,0,0,0-1.838.758,2.005,2.005,0,0,0,0,2.829,2.058,2.058,0,0,0,2.828,0,1.173,1.173,0,0,1-.872.4l.176-.015c.2-.013.411-.035.616-.052.352-.028.7-.056,1.056-.082q1.1-.081,2.2-.145,2.2-.129,4.409-.189a2,2,0,0,0,0-4Z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        class="c"
                                                                                                ...
                                                                                                >
                                                                                                    ...
                                                                                                    <path
                                                                                                        style="
                                                                                                            ...
                                                                                                            stroke: #888888;
                                                                                                        "
                                                                                                        d="M 1.7,8.5 6.2,6.6 54,1.5 56,18 9.7,24 5.3,25 z"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: none;
                                                                                                            stroke: #dddddd;
                                                                                                        "
                                                                                                        d="M 6.2,7.5 C 7.1,12 8.5,20 9.7,23"
                                                                                                    ></path>
                                                                                                    <path
                                                                                                        style="
                                                                                                            fill: #cccccc;
                                                                            ...
                                                                            <tbody>
                                                                                @foreach ($visit->vitals as $vital)
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-center">
                                                                                            {{ $vitalData->blood_sugar_level ?? 'N/A' }}
                                                                                        </td>
                                                                                        <td class="text-center">
                                                                                            {{ Str::headline(ReferenceHelper::bmi($vitalData->height, $vitalData->weight)) }}
                                                                                        </td>
                                                                                        <td class="text-center">
                                                                                            {{ Str::headline(ReferenceHelper::hypertensionStage($vitalData->systolic_pressure, $vitalData->diastolic_pressure)) }}
                                                                                        </td>
                                                                                        <td class="text-center">
                                                                                            {{ $vital->user->fullname() }}
                                                                                        </td>
