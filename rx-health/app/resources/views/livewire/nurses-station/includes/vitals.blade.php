    ...
    <thead>
        <tr>
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Temperature">
                    <i class="text-primary fa fa-thermometer-half icons-base"></i>
                    <span class="text-muted">℃</span>
                </div>
            </th>
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Weight">
                    <i class="text-primary fa fa-balance-scale icons-base"></i>
                    <span class="text-muted">kg</span>
                </div>
            </th>
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Height">
                    <i class="text-primary fa fa-arrows-v icons-base"></i>
                    <span class="text-muted">cm</span>
                </div>
            </th>
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Pulse">
                    <i class="text-primary fa fa-heartbeat icons-base"></i>
                    <span class="text-muted">bpm</span>
                </div>
            </th>
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Respiratory Rate">
                    <i class="text-primary fa fa-heartbeat icons-base"></i>
                    <span class="text-muted">brpm</span>
                </div>
            </th>

            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Blood Pressure">
                    <i class="text-primary fa fa-heart icons-base"></i>
                    <span class="text-muted">mmHg</span>
                </div>
            </th>
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Oxygen Saturation">
                    <svg
                        version="1.1"
                        id="Layer_1"
                    ...
                    >
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <g>
                                ...
                                ></path>
                                <rect x="192.4" y="122.4" style="fill: #78909c" width="51.2" height="83.2"></rect>
                            </g>
                            <path
                                style="fill: #ffcdd2"
                            ...
                            <g>
                                ...
                                ></path>
                                <path style="fill: #ffcdd2" d="M134,502v2h2C134.8,504,134,503.2,134,502z"></path>
                            </g>
                            <path
                                style="fill: #e0e0e0"
                            ...
                            ></path>
                            <polyline style="fill: #e0e0e0" points="338.8,4 338.8,186 366.4,186 366.4,4 "></polyline>
                            <path
                                style="fill: #bcaaa4"
                            ...
                            ></path>
                            <path style="fill: #ffcdd2" d="M340,189.2v2h2C340.8,191.2,340,190.4,340,189.2z"></path>
                            <path
            ...
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Blood Sugar Level">
                    <svg
                        version="1.1"
                        id="Layer_1"
                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <g>
                                <g>
                                    <g>
                                        <g>
                                            <circle style="fill: #6dc0bb" cx="148.5" cy="148.5" r="148.5"></circle>
                                        </g>
                                    </g>
                                </g>
                                <path
                    ...
                    <span class="text-muted">mmol/L (RBS)</span>
                </div>
            </th>
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2" title="Blood Sugar Level">
                    ...
                    <span class="text-muted">mmol/L (FBS)</span>
                </div>
            </th>
            {{--
                <th scope="col" class="p-2">
                ...
                <span class="text-muted">mmol/L</span>
                </div>
                </th>
            --}}
            <th scope="col" class="p-2">
                <div class="me-2 d-flex justify-content-center align-content-center gap-2">
                ...
                <div class="me-2 d-flex justify-content-center align-content-center gap-2">
                    ...
                    >
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            ></path>
                            <path class="e" d="M355.5,216.133h33.53"></path>
                            <path
                                class="c"
                            ...
                            ></path>
                            <path class="e" d="M28.754,166.337q1.588,3.155,2.862,6.453"></path>
                            <path
                                class="a"
                ...
                <div class="me-2 d-flex justify-content-center align-content-center gap-2">
                    ...
                    >
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            ></path>
                            <path
                                style="fill: #287293; stroke: #888888"
                                d="M 1.7,8.5 6.2,6.6 54,1.5 56,18 9.7,24 5.3,25 z"
                            ></path>
                            <path style="fill: none; stroke: #dddddd" d="M 6.2,7.5 C 7.1,12 8.5,20 9.7,23"></path>
                            <path
                                style="fill: #cccccc; stroke: #888888"
                                d="m 9.7,23 -4.4,1 5.7,36 6,1 c 0,0 43,-10 43,-11 0,0 -4,-33 -4,-33 z"
                            ></path>
                            <path
                                style="fill: #eeeeee; stroke: #aaaaaa"
                                d="m 56,17 c 0,0 2,16 7,23 -2,4 -9,10 -13,10 -4,1 -31,10 -31,10 0,0 -2,-2 -4,-8 L 9.7,23 z"
                            ></path>
                            <path
                                style="fill: #dddddd; stroke: #aaaaaa"
                            ...
                            ></path>
                            <circle
                                style="fill: none; stroke: #eeeeee; stroke-width: 3"
                                cx="65"
                                cy="65"
                                r="34"
                            ></circle>
                            <circle style="fill: #444444; fill-opacity: 0.7" cx="65" cy="65" r="32"></circle>
                            <circle
                                style="stroke-width: 5pt; stroke: #222222; fill: none"
                                cx="65"
                                cy="65"
                                r="30"
                            ></circle>
                            <g style="fill: #aaaaaa">
                                <circle cx="65" cy="35" r="2.5"></circle>
                                <circle cx="95" cy="65" r="2.5"></circle>
                                <circle cx="65" cy="95" r="2.5"></circle>
                                <circle cx="35" cy="65" r="2.5"></circle>
                            </g>
                            <path style="stroke: #ffffff; stroke-width: 4; fill: none" d="M 65,65 60,42"></path>
                            <path style="stroke: #ffffff; stroke-width: 3; fill: none" d="M 65,65 44,87"></path>
                            <circle style="fill: #ffffff" cx="65" cy="65" r="3.5"></circle>
                        </g>
                    </svg>
    ...
    <tbody>
        @forelse ($vitals as $vital)
            ...
            <tr>
                ...
                <td class="text-center">
                    {{ $vitalData->random_blood_sugar_level ?? 'N/A' }}
                </td>
                <td class="text-center">
                    {{ $vitalData->fasting_blood_sugar_level ?? 'N/A' }}
                </td>
                {{--
                    <td class="text-center">
                ...
                @if ($from_ward)
                    <td>
                        <a
                            href="#"
                            wire:click="loadDataToEditForMedicalRecord({{ $vital->id }})"
                            data-bs-toggle="modal"
                            data-bs-target="#add_or_edit_observation_chart"
                            title="Edit"
                        >
                            <i class="ri-pencil-line text-warning icons-sm"></i>
                        </a>
                        <a href="#" wire:click="deleteVital({{ $vital->id }})" title="Delete">
