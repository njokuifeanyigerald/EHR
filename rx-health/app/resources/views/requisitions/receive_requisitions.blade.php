    ...
    <div class="row">
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">List of Items To Receive</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="tab-content" id="pills-tabContent-2">
                ...
                >
                    <livewire:requisition.requisition-list :type="'pending_received'" />
                </div>

                {{-- Confirmed --}}
                <div class="tab-pane fade" id="Confirmed" role="tabpanel" aria-labelledby="Confirmed-tab">
                    <livewire:requisition.requisition-list :type="'confirmed_received'" />
                </div>
            </div>
        </div>
    </div>
