...
<div class="modal fade" id="add_po" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
                                        ...
                                        <div class="col-md-6 row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-select my-2" id="supplier_add_po">
                                                    ...
                                                    <option value="1">Central Medical Stores</option>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary my-2">Save Purchase Order</button>
            </div>
        </div>
    </div>
</div>
